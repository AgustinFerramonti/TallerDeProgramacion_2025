...
public class Libro {
   ...
   private PrimerAutor primerAutor; 
   ...
   private double precio; 
    ...
    int unAñoEdicion,  PrimerAutor unPrimerAutor, String unISBN, double unPrecio){
         titulo = unTitulo;
   ...
   @Override
    public String toString(){
        String aux;
        aux= titulo + " por " + primerAutor + "| Edicion: " + añoEdicion + " | " + " ISBN: " + ISBN;
       return ( aux);
    }
